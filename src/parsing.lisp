  ...
  (handler-bind ((cxml:well-formedness-violation
                   (lambda (e)
                     ...
                     (when-it (or (find-restart 'cxml::ignore-namespace)
                                  ...
                                  (find-restart 'cxml::consume-single-attrs)
                                  (find-restart 'cxml::use-unknown-ents-as-is)
                                  (find-restart 'cxml::close-entity)
                                  (find-restart 'cxml::skip-malformed-attr-val)
                                  (find-restart 'cxml::skip-codepoint)
